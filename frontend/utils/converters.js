...
const { Document, Packer, Paragraph, TextRun, Table, TableRow, TableCell, ImageRun, AlignmentType, HeadingLevel, BorderStyle } = require('docx');
const PptxGenJS = require('pptxgenjs');
const XLSX = require('xlsx');
const mammoth = require('mammoth');
const AdmZip = require('adm-zip');
const { fromPath } = require('pdf-to-img');
...
async function wordToExcel(wordPath) {
    try {
        ...
        // Create worksheet data with better structure
        const wsData = [
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'Document Content');
